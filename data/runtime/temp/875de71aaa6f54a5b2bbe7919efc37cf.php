<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"D:\phpsite\YFCMF/app/admin\view\sys\logsys.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<link rel="stylesheet" href="__PUBLIC__/bootstrap-select/css/bootstrap-select.min.css">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="urlsys" method="post" action="<?php echo url('runlogsys'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否定时清日志： </label>
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="clear_on" id="clear_on"  <?php if(config('log.clear_on')): ?>checked<?php endif; ?> value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" name="timebf" id="timebf" value="<?php echo config('log.timebf'); ?>" class="col-xs-5" />
...
<script>
$('.selectpicker').selectpicker('val',"<?php echo $log['level']; ?>".split(','));
</script>
