<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:49:"D:\phpsite\YFCMF/app/admin\view\model\cmsadd.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="page-header">
			<h1>
				...
				<small>
					...
					增加<?php echo $model['model_title']; ?>
				</small>
			</h1>
		</div>
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="plug_ad_runedit" method="post" action="<?php echo url('cmsrunadd'); ?>">
					...
					<?php if(is_array($fields_data) || $fields_data instanceof \think\Collection): if( count($fields_data)==0 ) : echo "" ;else: foreach($fields_data as $k=>$f): switch($f['type']): case "baidu_map": ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php if(in_array('required',$f['rules'])): ?> required <?php endif; ?>/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo $f['title']; ?>：  </label>
                                <div class="col-sm-10">
                                    <input type="checkbox" value='1' name="<?php echo $k; ?>" class="ace ace-switch ace-switch-4 btn-flat" <?php if($f['value'] == 1): ?>checked<?php endif; if(in_array('required',$f['rules'])): ?> required <?php endif; ?>/>
                                    <span class="lbl">&nbsp;&nbsp;<span class="red"><?php if(in_array('required',$f['rules'])): ?>*<?php endif; ?></span><?php echo htmlspecialchars($f['description']); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php if(in_array('required',$f['rules'])): ?> required <?php endif; ?>><?php echo htmlspecialchars($f['value']); ?>
                                    </textarea>
                                    <span class="lbl">&nbsp;&nbsp;<span class="red"><?php if(in_array('required',$f['rules'])): ?>*<?php endif; ?></span><?php echo htmlspecialchars($f['description']); ?></span>
                                </div>
                            </div>
