<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"D:\phpsite\YFCMF/app/admin\view\login\login.html";i:1484628860;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
						...
						<div id="login-box" class="login-box visible widget-box no-border">
							<div class="widget-body">
								<div class="widget-main">
									...
									<div class="space-6"></div>
									<form class="ajaxForm3" name="runlogin" id="runlogin" method="post" action="<?php echo url('runlogin'); ?>">
										<fieldset>
											...
											<!--<label class="block clearfix">-->
												<!--<span class="block text-center">-->
													<!--<img class="verify_img" id="verify_img" src="<?php echo url('Login/verify'); ?>" onClick="this.src='<?php echo url('Login/verify'); ?>'+'?'+Math.random()" style="cursor: pointer;width:100%;border: 1px solid #d5d5d5;" title="点击获取">-->
												<!--</span>-->
											<!--</label>-->
											<!--<?php endif; ?>-->
