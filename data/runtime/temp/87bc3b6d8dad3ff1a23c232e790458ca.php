<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"D:\phpsite\YFCMF/app/admin\view\sys\langsys.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="urlsys" method="post" action="<?php echo url('runlangsys'); ?>">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 是否开启多语言： </label>
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="lang_switch_on" id="lang_switch_on" <?php if(\think\Config::get('lang_switch_on') == 1): ?>checked<?php endif; ?>  value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 默认多语言 </label>
						<div class="col-sm-9">
							<input type="text" name="default_lang" value="<?php echo \think\Config::get('default_lang'); ?>"  class="col-xs-10 col-sm-5" />
