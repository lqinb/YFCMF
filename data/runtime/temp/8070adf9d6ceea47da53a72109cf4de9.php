<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:50:"D:\phpsite\YFCMF/app/admin\view\sys\urlsetsys.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:55:"D:\phpsite\YFCMF/app/admin\view\sys\ajax_urlsetsys.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row">
			...
			<div class="tabbable">
				...
				<div id="basic" class="tab-pane fade">
						<form class="form-horizontal ajaxForm2" name="urlsys" method="post" action="<?php echo url('runurlsys'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="complete_match" id="complete_match" <?php if(\think\Config::get('url_complete_match') == 1): ?>checked<?php endif; ?>  value="1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					<div class="space-4"></div>
					...
					<div id="urllist" class="tab-pane fade in active">
						...
						<div class="row">
							<div class="col-xs-12">
								<div>
									<form class="ajaxForm" name="route_order" method="post" action="<?php echo url('route_order'); ?>" >
										<table class="table table-striped table-bordered table-hover" id="dynamic-table">
											...
											<tbody id="ajax-data">
												<?php if(is_array($routes) || $routes instanceof \think\Collection): if( count($routes)==0 ) : echo "" ;else: foreach($routes as $key=>$v): ?>
	<tr>
		...
		<td class="hidden-xs">
			<?php if($v['status'] == 1): ?>
				<a class="red open-btn" href="<?php echo url('route_state'); ?>" data-id="<?php echo $v['id']; ?>" title="启用">
					<div id="zt<?php echo $v['id']; ?>"><button class="btn btn-minier btn-yellow">启用</button></div>
				</a>
				<?php else: ?>
				<a class="red open-btn" href="<?php echo url('route_state'); ?>" data-id="<?php echo $v['id']; ?>" title="禁用">
		...
		<td>
			<div class="hidden-sm hidden-xs action-buttons">
				<a class="green routeedit-btn"  href="<?php echo url('route_edit'); ?>" data-toggle="modal" data-target="#myModaledit" data-id="<?php echo $v['id']; ?>"  title="修改">
					<i class="ace-icon fa fa-pencil bigger-130"></i>
				</a>
				<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('route_del',array('id'=>$v['id'])); ?>" title="删除">
			...
			<div class="hidden-md hidden-lg">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<li>
							<a href="<?php echo url('route_edit'); ?>" data-id="<?php echo $v['id']; ?>" class="tooltip-success sourceedit-btn" data-rel="tooltip" title="" data-original-title="修改">
						<span class="green">
						...
						<li>
							<a href="<?php echo url('route_del',array('id'=>$v['id'])); ?>"  class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-info="你确定要删除吗？" data-original-title="删除">
						<span class="red">
...
<tr>
	...
	<td height="50" colspan="12" align="right"><?php echo $page; ?></td>
		...
		<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<form class="form-horizontal ajaxForm2" name="route_add" method="post" action="<?php echo url('route_runadd'); ?>">
		...
		<div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<form class="form-horizontal ajaxForm2" name="route_runedit" method="post" action="<?php echo url('route_runedit'); ?>">
