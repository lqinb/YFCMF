<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:50:"D:\phpsite\YFCMF/app/admin\view\model\cmslist.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:55:"D:\phpsite\YFCMF/app/admin\view\model\ajax_cmslist.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2  margintop5">
				<a href="<?php echo url('cmsadd',['id'=>$model_id]); ?>">
					<button class="btn btn-sm btn-danger">
						<i class="ace-icon fa fa-bolt bigger-110"></i>
						添加<?php echo $model['model_title']; ?>
					</button>
				</a>
			</div>
			<form name="admin_list_sea" class="form-search form-horizontal" id="list-filter" method="post" action="<?php echo url('cmslist'); ?>">
			<div class="col-xs-8 col-sm-10 btn-sespan">
				...
				<select name="<?php echo $model['model_cid']; ?>" class="ajax_change">
					...
					<option value="<?php echo $vo['id']; ?>" <?php if($vo['menu_type'] == 1): ?>class="bgccc"<?php else: ?>class="bgc"<?php endif; if($model_cid == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['lefthtml']; ?><?php echo $vo['menu_name']; if($vo['menu_type'] == 1): ?>(频道页)<?php endif; ?></option>
				...
				<div class="input-group-btn">
					<a href="<?php echo url('cmslist',['id'=>$model_id]); ?>">
		...
		<div class="row">
			<div class="col-xs-12">
				<form id="alldel" name="alldel" method="post" action="<?php echo url('cmsalldel'); ?>" >
					<input name="id" value="<?php echo $model_id; ?>" type="hidden" />
					<div>
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<tr>
								...
								<th>排序</th>
								<?php if(is_array($fields) || $fields instanceof \think\Collection): if( count($fields)==0 ) : echo "" ;else: foreach($fields as $k=>$v): if($k != $model['model_order']): ?>
