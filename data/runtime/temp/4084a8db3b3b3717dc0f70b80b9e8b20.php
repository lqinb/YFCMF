<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:56:"D:\phpsite\YFCMF/app/admin\view\News\news_menu_edit.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="runnews_menuedit" method="post" action="<?php echo url('news_menu_runedit'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name="menu_l"  class="col-sm-3 " disabled required>
					...
					<div class="form-group" id="model">
						...
						<div class="col-sm-9">
							<select name="menu_modelid"  class="col-sm-3 selector">
								...
								<?php if(is_array($model) || $model instanceof \think\Collection): if( count($model)==0 ) : echo "" ;else: foreach($model as $key=>$vo): ?>
					...
					<div class="form-group" id="listtpl">
						...
						<div class="col-sm-9">
							<select name="menu_listtpl"  class="col-sm-3 selector">
								...
								<?php if(is_array($tpls) || $tpls instanceof \think\Collection): if( count($tpls)==0 ) : echo "" ;else: foreach($tpls as $key=>$vo): ?>
