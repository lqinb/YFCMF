<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:59:"D:\phpsite\YFCMF/app/admin\view\sys\admin_group_access.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="admin_group_runaccess" method="post" action="<?php echo url('admin_group_runaccess'); ?>">
					...
					<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<?php if(is_array($datab) || $datab instanceof \think\Collection): if( count($datab)==0 ) : echo "" ;else: foreach($datab as $key=>$vo): ?>
							<tr>
							...
							<?php if(is_array($vo['sub']) || $vo['sub'] instanceof \think\Collection): if( count($vo['sub'])==0 ) : echo "" ;else: foreach($vo['sub'] as $key=>$sub): ?>
								<tr>
								...
								<?php if(is_array($sub['sub']) || $sub['sub'] instanceof \think\Collection): if( count($sub['sub'])==0 ) : echo "" ;else: foreach($sub['sub'] as $key=>$subb): ?>
									<tr>
									...
									<?php if(!empty($subb['sub'])): ?>
										<tr>
											<td height="30" style="padding-left:70px;border-bottom:#E7EBF8 dashed 1px; color:#666666">
												<?php if(is_array($subb['sub']) || $subb['sub'] instanceof \think\Collection): $i = 0; $__LIST__ = $subb['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$subbb): $mod = ($i % 2 );++$i;?>
													<label class="thopen">
