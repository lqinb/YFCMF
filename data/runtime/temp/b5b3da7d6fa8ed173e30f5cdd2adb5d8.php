<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:57:"D:\phpsite\YFCMF/app/admin\view\sys\admin_group_list.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-12 col-sm-2">
				<a href="<?php echo url('admin_group_add'); ?>">
				...
				<div>
					<form id="leftnav" name="leftnav" method="post" action="" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($auth_group) || $auth_group instanceof \think\Collection): if( count($auth_group)==0 ) : echo "" ;else: foreach($auth_group as $key=>$v): ?>
								<tr>
									<td height="28"><?php echo $v['id']; ?></td>
									<td><?php echo $v['title']; ?></td>
									<td id="h<?php echo $v['id']; ?>">
										<?php if($v['status'] == 1): ?>
											<a class="red open-btn" href="<?php echo url('admin_group_state'); ?>" data-id="<?php echo $v['id']; ?>" title="已开启">
												<div id="zt<?php echo $v['id']; ?>"><button class="btn btn-minier btn-yellow">开启</button></div>
											</a>
											<?php else: ?>
											<a class="red open-btn" href="<?php echo url('admin_group_state'); ?>" data-id="<?php echo $v['id']; ?>" title="已禁用">
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="blue" href="<?php echo url('admin_group_access',array('id'=>$v['id'])); ?>" title="配置规则">
												<i class="ace-icon fa fa-cog bigger-130"></i>
											</a>
											<a class="green" href="<?php echo url('admin_group_edit',array('id'=>$v['id'])); ?>" title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>
											</a>
											<a class="red confirm-rst-url-btn" href="<?php echo url('admin_group_del',array('id'=>$v['id'])); ?>" data-info="你确定要删除吗？" title="删除">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo url('admin_group_access',array('id'=>$v['id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="配置规则">
																	<span class="green">
													...
													<li>
														<a href="<?php echo url('admin_group_edit',array('id'=>$v['id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
													...
													<li>
														<a href="<?php echo url('admin_group_del',array('id'=>$v['id'])); ?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																	<span class="red">
