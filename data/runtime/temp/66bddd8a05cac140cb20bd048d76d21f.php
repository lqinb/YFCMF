<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"D:\phpsite\YFCMF/app/admin\view\index\index.html";i:1485141626;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="alert alert-block alert-success">
					...
					为了您更好的使用本系统，建议屏幕分辨率1280*768以上，并且安装chrome谷歌浏览器 ——— <a href="<?php echo url('Help/soft'); ?>">进入软件下载专区</a>
				</div>
				<div class="row">
					...
					<div class="col-sm-7 infobox-container">
						<div class="row">
							<div class="col-xs-12">
								<h3 class="header smaller lighter green">快捷入口</h3>

								<p>
									<a href="<?php echo url('Url/index', ['u_id' => 1]); ?>" class="btn btn-default btn-app" style="margin: 10px">
										<i class="icon-cog bigger-230" style="padding-left: 10px;"></i>
										<br />
										站点设置
									...
									<a href="<?php echo url('Url/index', ['u_id' => 2]); ?>" class="btn btn-app btn-primary" style="margin: 10px">
										<i class="icon-edit bigger-230" style="padding-left: 10px;"></i>
										<br />
										发布文章
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>

									<a href="<?php echo url('Url/index', ['u_id' => 3]); ?>" class="btn btn-app btn-success" style="margin: 10px">
										<i class="icon-asterisk bigger-230" style="padding-left: 10px;"></i>
										<br />
										文章列表
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>
									<a href="<?php echo url('Url/index', ['u_id' => 4]); ?>" class="btn btn-app btn-warning" style="margin: 10px">
										<i class="icon-flag bigger-230" style="padding-left: 10px;"></i>
										<br />
										企业简介
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>
									...
									<a href="<?php echo url('Url/index', ['u_id' => 5]); ?>" class="btn btn-app btn-info" style="margin: 10px">
										<i class="icon-heart bigger-230" style="padding-left: 10px;"></i>
										<br />
										荣誉资质
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>

									<a href="<?php echo url('Url/index', ['u_id' => 6]); ?>" class="btn btn-app btn-danger" style="margin: 10px">
										<i class="icon-key bigger-230" style="padding-left: 10px;"></i>
										<br />
										经营理念
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>

									<a href="<?php echo url('Url/index', ['u_id' => 7]); ?>" class="btn btn-app btn-purple" style="margin: 10px">
										<i class="icon-coffee bigger-230" style="padding-left: 10px;"></i>
										<br />
										企业精神
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>
									<a href="<?php echo url('Url/index', ['u_id' => 8]); ?>" class="btn btn-app btn-danger" style="margin: 10px">
										<i class=" icon-bookmark bigger-230" style="padding-left: 10px;"></i>
										<br />
										行为准则
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>

									<a href="<?php echo url('Url/index', ['u_id' => 9]); ?>" class="btn btn-app btn-pink" style="margin: 10px">
										<i class="icon-camera bigger-230" style="padding-left: 10px;"></i>
										<br />
										轮播图片
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>
									...
									<a href="<?php echo url('Url/index', ['u_id' => 10]); ?>" class="btn btn-app btn-grey" style="margin: 10px">
										<i class="icon-bullhorn bigger-230" style="padding-left: 10px;"></i>
										<br />
										滚动通知
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>

									<a href="<?php echo url('Url/index', ['u_id' => 11]); ?>" class="btn btn-app btn-light" style="margin: 10px">
										<i class="icon-bar-chart bigger-230" style="padding-left: 10px;"></i>
										<br />
										菜单管理
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>

									<a href="<?php echo url('Url/index', ['u_id' => 12]); ?>" class="btn btn-app btn-yellow" style="margin: 10px">
										<i class="icon-lemon bigger-230" style="padding-left: 10px;"></i>
										<br />
										管理员管理
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>
									<a href="<?php echo url('Url/index', ['u_id' => 13]); ?>" class="btn btn-app btn-inverse" style="margin: 10px">
										<i class="icon-envelope bigger-230" style="padding-left: 10px;"></i>
										<br />
										联系我们
										<!--<span class="badge badge-warning badge-left">11</span>-->
									</a>
							...
							<div class="widget-body">
								<div class="widget-main">
									<p class="alert alert-danger sl-line-height25">
										后台版本：<?php echo \think\Config::get('yfcmf_version'); ?> &nbsp;
										...
										<?php else: ?>
											<a href="<?php echo url('Update/index'); ?>" title="在线更新"><button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-bolt bigger-110"></i><?php echo $ver_str; ?></button></a>
										<?php endif; endif; ?>
										<br />
					...
					<div class="col-sm-5">
								...
								<div class="widget-main no-padding">
									<table class="table table-striped table-bordered table-hover">
										...
										$color=array("badge badge-pink","badge badge-yellow","badge badge-danger","badge badge-warning","badge badge-success","badge badge-inverse","badge badge-purple","badge badge-info","badge badge-grey","badge");
										 if(is_array($news_list) || $news_list instanceof \think\Collection): if( count($news_list)==0 ) : echo "" ;else: foreach($news_list as $k=>$v): ?>
										<tr>
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<span class=""></span> 日常维护
							</div>
							<table class="table">
								<tbody>
								<tr>
									<td colspan="2">
										<a href="<?php echo url('Sys/maintain',array('action'=>'download_log')); ?>" target="_blank" class="btn btn-default maintain">下载日志</a>
										<a href="<?php echo url('Sys/maintain',array('action'=>'view_log')); ?>" target="_blank" class="btn btn-default maintain">查看日志</a>
										<a href="<?php echo url('Sys/maintain',array('action'=>'clear_log')); ?>" class="btn btn-default rst-url-btn maintain">清除日志</a>
										<?php if($danger_mode_debug): ?>
										<a href="<?php echo url('Sys/maintain',array('action'=>'debug_off')); ?>" class="btn btn-default rst-url-btn maintain">关闭调试</a>
										<?php else: ?>
										<a href="<?php echo url('Sys/maintain',array('action'=>'debug_on')); ?>" class="btn btn-default rst-url-btn maintain">打开调试</a>
										<?php endif; if($system_pageshow): ?>
										<a href="<?php echo url('Sys/maintain',array('action'=>'trace_off')); ?>" class="btn btn-default rst-url-btn maintain">关闭Trace</a>
										<?php else: ?>
										<a href="<?php echo url('Sys/maintain',array('action'=>'trace_on')); ?>" class="btn btn-default rst-url-btn maintain">打开Trace</a>
										<?php endif; ?>
									</td>
								</tr>
								<tr>
