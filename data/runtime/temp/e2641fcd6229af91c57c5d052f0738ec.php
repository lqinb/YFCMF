...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal modelform" name="model_edit" method="post" action="<?php echo url('model_runadd'); ?>">
							...
							<div class="col-sm-10 col-xs-12 no-padding-left">
								<table class="table table-striped table-bordered table-hover" id="dynamic-table">
									...
									<tbody id="fields-data">
										<?php if(is_array($fields) || $fields instanceof \think\Collection): if( count($fields)==0 ) : echo "" ;else: foreach($fields as $key=>$v): ?>
										<tr>
											...
											<td style="border-right:#CCC solid 1px;">
												<div class="action-buttons">
													<a class="blue" href="javascript:void(0)" onclick="insert_field(this)" title="插入字段"><i class="ace-icon fa fa-plus-circle bigger-130"></i></a>
													<a class="green" href="javascript:void(0)" onclick="edit_field(this)" title="修改"><i class="ace-icon fa fa-pencil bigger-130"></i></a>
													<a class="red" href="javascript:void(0)" onclick="delete_field(this)" data-info="你确定要删除吗？" title="删除"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>
													<a class="green" href="javascript:void(0)" onclick="up_field(this)" title="上移"><i class="ace-icon fa fa-arrow-up bigger-130"></i></a>
													<a class="green" href="javascript:void(0)" onclick="down_field(this)" title="上移"><i class="ace-icon fa fa-arrow-down bigger-130"></i></a>
												</div>
											</td>
										</tr>
...
$(function () {
    ...
    $('.insert-field').click(function () {
		...
		var $field_data = Modal.find('#field_data').val(),
			...
			$html='<tr><td>'+$field_name+'</td><td>'+$field_title+'</td><td>'+$field_type+'</td><td class="hidden">'+$field_data+'</td><td class="hidden">'+$field_desc+'</td><td class="hidden">'+$field_length+'</td><td>'+$field_rules+'</td><td class="hidden">'+$field_default+'</td><td style="border-right:#CCC solid 1px;"><div class="action-buttons"><a class="blue" href="javascript:void(0)" onclick="insert_field(this)" title="插入字段"><i class="ace-icon fa fa-plus-circle bigger-130"></i></a><a class="green" href="javascript:void(0)" onclick="edit_field(this)" title="修改"><i class="ace-icon fa fa-pencil bigger-130"></i></a><a class="red" href="javascript:void(0)" onclick="delete_field(this)" data-info="你确定要删除吗？" title="删除"><i class="ace-icon fa fa-trash-o bigger-130"></i></a><a class="green" href="javascript:void(0)" onclick="up_field(this)" title="上移"><i class="ace-icon fa fa-arrow-up bigger-130"></i></a><a class="green" href="javascript:void(0)" onclick="down_field(this)" title="上移"><i class="ace-icon fa fa-arrow-down bigger-130"></i></a></div></td></tr>';
    ...
    $('.edit-field').click(function () {
        ...
        if($field_name=='' || $field_title=='' || $field_type==''){
            ...
            $field_desc = Modal.find('#field_desc').val(),
            $field_rules = (Modal.find('.filter-option').html()=='未选择')?'':Modal.find('.filter-option').html();
            $html='<td>'+$field_name+'</td><td>'+$field_title+'</td><td>'+$field_type+'</td><td class="hidden">'+$field_data+'</td><td class="hidden">'+$field_desc+'</td><td class="hidden">'+$field_length+'</td><td>'+$field_rules+'</td><td class="hidden">'+$field_default+'</td><td style="border-right:#CCC solid 1px;"><div class="action-buttons"><a class="blue" href="javascript:void(0)" onclick="insert_field(this)" title="插入字段"><i class="ace-icon fa fa-plus-circle bigger-130"></i></a><a class="green" href="javascript:void(0)" onclick="edit_field(this)" title="修改"><i class="ace-icon fa fa-pencil bigger-130"></i></a><a class="red" href="javascript:void(0)" onclick="delete_field(this)" data-info="你确定要删除吗？" title="删除"><i class="ace-icon fa fa-trash-o bigger-130"></i></a><a class="green" href="javascript:void(0)" onclick="up_field(this)" title="上移"><i class="ace-icon fa fa-arrow-up bigger-130"></i></a><a class="green" href="javascript:void(0)" onclick="down_field(this)" title="上移"><i class="ace-icon fa fa-arrow-down bigger-130"></i></a></div></td>';
            var $tr_index = Modal.find('#tr_index').val();
