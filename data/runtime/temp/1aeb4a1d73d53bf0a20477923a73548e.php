<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:50:"D:\phpsite\YFCMF/app/admin\view\news\news_add.html";i:1486178246;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="page-header">
			<h1>
				...
				<small>
					...
					<?php if($signal == 1): ?>企业资质上传<?php endif; if($signal == ''): ?>添加文章<?php endif; ?>
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('news_runadd'); ?>"  enctype="multipart/form-data">
					<?php if($signal == 1): ?>
					<input name="news_columnid" type="hidden" id="news_columnid" value="21" >
					<input name="news_title" type="hidden" id="news_title" value="zizhizizhi" >


					<?php endif; if($signal != 1): ?>
						...
						<div class="col-sm-10">
							<select name="news_columnid"  class="col-sm-3 selector" required>
								...
								<?php if(is_array($menu) || $menu instanceof \think\Collection): if( count($menu)==0 ) : echo "" ;else: foreach($menu as $key=>$vo): ?>
									<!--<option value="<?php echo $vo['id']; ?>" <?php if($vo['menu_type'] == 1): ?>disabled class="bgccc"<?php else: ?>class="bgc"<?php endif; ?>><?php echo $vo['lefthtml']; ?><?php echo $vo['menu_name']; ?>(<?php if($vo['menu_l'] == 'zh-cn'): ?>中<?php else: ?>英<?php endif; ?>) <?php if($vo['menu_type'] == 1): ?>(频道页)<?php endif; ?></option>-->
					...
					<div class="form-group">
						...
						<div class="checkbox">
							<?php if(is_array($diyflag) || $diyflag instanceof \think\Collection): if( count($diyflag)==0 ) : echo "" ;else: foreach($diyflag as $key=>$diyflag): ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<label class="input_last">
								常用：
								<?php if(is_array($source) || $source instanceof \think\Collection): $i = 0; $__LIST__ = $source;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$k): $mod = ($i % 2 );++$i;?>
