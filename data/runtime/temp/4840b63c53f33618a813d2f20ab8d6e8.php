<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"D:\phpsite\YFCMF/app/admin\view\sys\import.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="col-xs-12">
				<div>
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<?php if(is_array($data_list) || $data_list instanceof \think\Collection): if( count($data_list)==0 ) : echo "" ;else: foreach($data_list as $key=>$v): ?>
							<tr>
								<td height="28"><?php echo date('Ymd-His',$v['time']); ?></td>
								<td><?php echo $v['part']; ?></td>
								<td><?php if($v['compress'] == 'GZ'): ?><?php echo $v['compress']; else: ?>无压缩<?php endif; ?></td>
								<td class="hidden-sm hidden-xs"><?php echo format_bytes($v['size']); ?></td>
								<td class="hidden-sm hidden-xs"><?php echo $key; ?></td>
								<td>
									<div class="hidden-sm hidden-xs action-buttons">
										<a class="db-import confirm-rst-url-btn" data-info="你确定要还原吗？" href="<?php echo url('restore?time='.$v['time']); ?>" title="还原">
											<i class="ace-icon fa fa-reply-all bigger-130"></i>
										</a>
										<?php if($v['compress'] == 'GZ'): ?>
										<a class="db-import" href="__DATA__/backup/<?php echo date('Ymd-His',$v['time']); ?>-<?php echo $v['part']; ?>.sql.<?php echo $v['compress']; ?>" title="下载">
										<?php else: ?>
										<a class="db-import" href="__DATA__/backup/<?php echo date('Ymd-His',$v['time']); ?>-<?php echo $v['part']; ?>.sql" title="下载">
										<?php endif; ?>
											<i class="ace-icon fa fa-cloud-download bigger-130"></i>
										</a>
										<a class="confirm-rst-url-btn" href="<?php echo url('del?time='.$v['time']); ?>"  data-info="你确定要删除吗？" title="删除">
									...
									<div class="hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
												<li>
													<a href="<?php echo url('restore?time='.$v['time']); ?>"  data-info="你确定要还原吗？" class="tooltip-success confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="还原">
																<span class="green">
												...
												<li>
													<?php if($v['compress'] == 'GZ'): ?>
													<a href="__DATA__/backup/<?php echo date('Ymd-His',$v['time']); ?>-<?php echo $v['part']; ?>.sql.<?php echo $v['compress']; ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="下载">
													<?php else: ?>
													<a href="__DATA__/backup/<?php echo date('Ymd-His',$v['time']); ?>-<?php echo $v['part']; ?>.sql" class="tooltip-success" data-rel="tooltip" title="" data-original-title="下载">
													<?php endif; ?>
																			<span class="green">
												...
												<li>
													<a href="<?php echo url('del?time='.$v['time']); ?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																<span class="red">
