<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:54:"D:\phpsite\YFCMF/app/admin\view\service\news_edit.html";i:1486178153;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="page-header">
			<h1>
				...
				<small>
					...
					修改<?php echo $news_list['news_title']; ?>项目
				</small>
			</h1>
		</div>
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="form0" method="post" action="<?php echo url('news_runedit'); ?>"  enctype="multipart/form-data">
					...
					<div class="space-4"></div>
					<div class="form-group" id="pptaddress" style="display: none">
					...
					<div class="form-group" id="cpprice" style="display: none">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-10">
                                        <ul>
                                            <?php if(is_array($pic_list) || $pic_list instanceof \think\Collection): $i = 0; $__LIST__ = $pic_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
