<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:52:"D:\phpsite\YFCMF/app/admin\view\model\model_add.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal modelform" name="model_add" method="post" action="<?php echo url('model_runadd'); ?>">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 模型标识：  </label>
						<div class="col-sm-10">
							<input type="text" name="model_name" onKeyUp="value=value.replace(/[^\w\.\/]/ig,'')" id="model_name" onblur="auto_pk()" placeholder="输入模型标识" class="col-xs-6 col-sm-6" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="model_title" id="model_title" placeholder="输入模型标题" class="col-xs-6 col-sm-6" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="model_pk" id="model_pk" placeholder="输入模型主键" class="col-xs-6 col-sm-6" required/>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="model_cid" id="model_cid" placeholder="如'xxx_cid'" class="col-xs-6 col-sm-6" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填,单字段，不应包含在上述字段列表内</span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="model_order" id="model_order" placeholder="如'xxx_order'" class="col-xs-6 col-sm-6" required/>
							<span class="lbl">&nbsp;&nbsp;<span class="red">*</span>必填,单字段，不应包含在上述字段列表内</span>
						</div>
					</div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="model_list" id="model_list" placeholder="输入列表要显示的字段" class="col-xs-6 col-sm-6"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="model_edit" id="model_edit" placeholder="输入编辑时允许编辑的字段" class="col-xs-6 col-sm-6"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="model_sort" id="model_sort" placeholder="输入列表排序字段" class="col-xs-6 col-sm-6"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="model_indexes" id="model_indexes" placeholder="输入模型索引字段" class="col-xs-6 col-sm-6"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="search_list" id="search_list" placeholder="输入模型搜索字段" class="col-xs-6 col-sm-6"/>
                            <span class="lbl">&nbsp;&nbsp;<span class="red"></span>格式：'字段a,字段b',可以包含多个字段</span>
                        </div>
                    </div>
					<div class="form-group">
