<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:53:"D:\phpsite\YFCMF/app/admin\view\model\model_list.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
			...
			<div class="col-xs-12">
				<div>
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tbody>
							<?php if(is_array($models) || $models instanceof \think\Collection): if( count($models)==0 ) : echo "" ;else: foreach($models as $key=>$v): ?>
							<tr>
								...
								<td>
									<?php if($v['model_status'] == 1): ?>
										<a class="red open-btn" href="<?php echo url('model_state'); ?>" data-id="<?php echo $v['model_id']; ?>" title="已开启">
											<div id="zt<?php echo $v['model_id']; ?>"><button class="btn btn-minier btn-yellow">开启</button></div>
										</a>
										<?php else: ?>
										<a class="red open-btn" href="<?php echo url('model_state'); ?>" data-id="<?php echo $v['model_id']; ?>" title="已禁用">
								...
								<td>
									<div class="hidden-sm hidden-xs action-buttons">
										...
										<a class="green confirm-url-btn"  href="<?php echo url('model_edit',['model_id'=>$v['model_id']]); ?>" data-info="将重建数据库,原有数据自动备份，确认修改？" data-toggle="tooltip" title="修改">
											<i class="ace-icon fa fa-pencil bigger-130"></i>
										</a>
										<a class="green"  href="<?php echo url('model_copy',['model_id'=>$v['model_id']]); ?>"  data-toggle="tooltip" title="复制模型">
											<i class="ace-icon fa fa-exchange bigger-130"></i>
										</a>
										<a class="red confirm-rst-url-btn" href="<?php echo url('model_del',array('model_id'=>$v['model_id'])); ?>" data-info="你确定要删除吗？不建议直接删除" data-toggle="tooltip" title="删除">
									...
									<div class="hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
												...
												<li>
													<a href="<?php echo url('model_edit',['model_id'=>$v['model_id']]); ?>" class="tooltip-success confirm-url-btn" data-rel="tooltip" title="修改" data-info="将重建数据库,原有数据自动备份，确认修改？" data-original-title="修改">
																<span class="green">
												...
												<li>
													<a href="<?php echo url('model_copy',['model_id'=>$v['model_id']]); ?>" class="tooltip-success" data-rel="tooltip" title="复制模型"  data-original-title="复制模型">
																<span class="green">
												...
												<li>
													<a href="<?php echo url('model_del',array('model_id'=>$v['model_id'])); ?>"  class="tooltip-error confirm-rst-url-btn" data-info="你确定要删除吗？不建议直接删除" data-rel="tooltip" title="删除" data-original-title="删除">
																<span class="red">
		...
		<div class="modal fade in" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<form class="form-horizontal ajaxForm2" name="model_addmenu" method="post" action="<?php echo url('model_addmenu'); ?>">
