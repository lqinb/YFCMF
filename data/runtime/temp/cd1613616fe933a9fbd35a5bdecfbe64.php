...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="admin_group_add" method="post" action="<?php echo url('admin_group_runadd'); ?>">

					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 用户组名：  </label>
						<div class="col-sm-10">
							<input type="text" name="title" id="title" placeholder="输入用户组名" class="col-xs-10 col-sm-4" required/>
						</div>
					</div>
