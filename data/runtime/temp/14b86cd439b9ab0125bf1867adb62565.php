<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:56:"D:\phpsite\YFCMF/app/admin\view\news\news_menu_list.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:61:"D:\phpsite\YFCMF/app/admin\view\news\ajax_news_menu_list.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
			<form name="admin_list_sea" class="form-search form-horizontal" id="list-filter" method="post" action="<?php echo url('news_menu_list'); ?>">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form class="ajaxForm2" name="leftnav" method="post" action="<?php echo url('news_menu_order',['lang_list'=>$menu_l]); ?>" >
	...
	<tr>
		...
		<td>
			<?php switch($v['menu_type']): case "1": ?><span class="label label-lg label-grey">频道栏目</span><?php break; case "2": ?><span class="label label-lg label-yellow">跳转栏目</span><?php break; case "3": if(!empty($v['menu_modelid'])): ?>
				<a class="green" href="<?php echo url('Model/cmslist?id='.$v['menu_modelid']); ?>" data-toggle="tooltip" title="列表管理"><span class="label label-lg label-pink">可发布栏目</span></a>
				<?php else: ?>
		...
		<td>
			<?php if($v['menu_open'] == 1): ?>
				<a class="red open-btn" href="<?php echo url('news_menu_state'); ?>" data-id="<?php echo $v['id']; ?>" title="已开启">
					<div><button class="btn btn-minier btn-yellow">开启</button></div>
				</a>
				<?php else: ?>
				<a class="red open-btn" href="<?php echo url('news_menu_state'); ?>" data-id="<?php echo $v['id']; ?>" title="已禁用">
		...
		<td>
			<div class="hidden-sm hidden-xs action-buttons">
				<a class="blue" href="<?php echo url('news_menu_add',array('id'=>$v['id'])); ?>"  data-toggle="tooltip" title="添加子类">
					<i class="ace-icon fa fa-plus-circle bigger-130"></i>																</a>
				<a class="green" href="<?php echo url('news_menu_edit',array('id'=>$v['id'])); ?>" data-toggle="tooltip" title="修改">
					<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
				<a class="red confirm-rst-url-btn" href="<?php echo url('news_menu_del',array('id'=>$v['id'],'lang_list'=>$menu_l)); ?>" data-info="若存在子菜单，则子菜单将一起被删除，你确定要删除吗？" data-toggle="tooltip" title="删除">
			...
			<div class="hidden-md hidden-lg">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<li>
							<a href="<?php echo url('news_menu_add',array('id'=>$v['id'])); ?>"  class="tooltip-success" data-rel="tooltip" title="添加子类" data-original-title="添加子类">
										<span class="green">
						...
						<li>
							<a href="<?php echo url('news_menu_edit',array('id'=>$v['id'])); ?>" class="tooltip-success" data-rel="tooltip" title="修改" data-original-title="修改">
										<span class="green">
						...
						<li>
							<a href="<?php echo url('news_menu_del',array('id'=>$v['id'],'lang_list'=>$menu_l)); ?>"  data-info="若存在子菜单，则子菜单将一起被删除，你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="删除" data-original-title="删除">
										<span class="red">
