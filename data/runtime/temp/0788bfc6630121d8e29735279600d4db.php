<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:51:"D:\phpsite\YFCMF/app/admin\view\sys\admin_list.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			...
			<div class="col-xs-10 col-sm-5 margintop5">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin_list'); ?>">
				...
				<div>
					<form id="leftnav" name="leftnav" method="post" action="" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($admin_list) || $admin_list instanceof \think\Collection): if( count($admin_list)==0 ) : echo "" ;else: foreach($admin_list as $key=>$v): ?>
								<tr>
									...
									<td>
										<?php if($v['admin_open'] == 1): ?>
											<a class="red open-btn" href="<?php echo url('admin_state'); ?>" data-id="<?php echo $v['admin_id']; ?>" title="已开启">
												<div id="zt<?php echo $v['admin_id']; ?>"><button class="btn btn-minier btn-yellow">开启</button></div>
											</a>
											<?php else: ?>
											<a class="red open-btn" href="<?php echo url('admin_state'); ?>" data-id="<?php echo $v['admin_id']; ?>" title="已禁用">
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" href="<?php echo url('admin_edit',array('admin_id'=>$v['admin_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
											<?php if($v['admin_id'] != 1): ?>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin_del',array('admin_id'=>$v['admin_id'])); ?>" title="删除">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo url('admin_edit',array('admin_id'=>$v['admin_id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
													...
													<?php if($v['admin_id'] != 1): ?>
														<li>
															<a href="<?php echo url('admin_del',array('admin_id'=>$v['admin_id'])); ?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																	<span class="red">
