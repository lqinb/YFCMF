<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"D:\phpsite\YFCMF/app/admin\view\sys\export.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="page-content">
        ...
        <div class="row maintop">
            <div class="col-xs-12 col-sm-8">
                ...
                <a id="optimize" href="<?php echo url('optimize'); ?>">
                    <button class="btn btn-xs btn-danger">
                        <i class="ace-icon fa fa-check-circle bigger-110"></i>
                        优化数据表
                    </button>
                </a>
                <a id="repair"  href="<?php echo url('repair'); ?>">
                    <button class="btn btn-xs btn-danger">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div>
                    <form id="export-form" method="post"   class="form-horizontal"  action="<?php echo url('export'); ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons" >
                                            <a class="green" href="<?php echo url('optimize?tables='.$v['name']); ?>" id="optimize_<?php echo $v['name']; ?>" title="优化表">
                                                <i class="ace-icon fa fa-check-circle bigger-130"></i>
                                            </a>
                                            <a class="info" href="<?php echo url('repair?tables='.$v['name']); ?>" id="repair_<?php echo $v['name']; ?>" title="修复表">
                                                <i class="ace-icon fa fa-check-square-o bigger-130"></i>
                                            </a>
                                            <a class="info backup" href="<?php echo url('exportsql?table='.$v['name']); ?>" title="备份表">
                                        ...
                                        <div class="hidden-md hidden-lg">
                                            <div class="inline position-relative">
                                                ...
                                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                    <li>
                                                        <a href="<?php echo url('optimize?tables='.$v['name']); ?>" id="optimize_<?php echo $v['name']; ?>"  class="tooltip-success" data-rel="tooltip" title="" data-original-title="优化表">
																	<span class="green">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo url('repair?tables='.$v['name']); ?>" id="repair_<?php echo $v['name']; ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修复表">
																	<span class="green">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo url('exportsql?table='.$v['name']); ?>"  class="tooltip-error" data-rel="tooltip" title="" data-original-title="备份表">
																	<span class="red">
