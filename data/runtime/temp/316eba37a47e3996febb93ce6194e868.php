<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:57:"D:\phpsite\YFCMF/app/admin\view\service\service_list.html";i:1486176952;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:59:"D:\phpsite\YFCMF/app/admin\view\Service\ajax_news_list.html";i:1486176961;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<form name="admin_list_sea" class="form-search form-horizontal" id="list-filter" method="post" action="<?php echo url('service_list'); ?>">
			<div class="row maintop">
				<div class="col-xs-4 col-sm-4 maintop" style="width: 35%;float: left;">
					<select name="keytype">
				...
				<div class="col-xs-4 col-sm-4 hidden-xs btn-sespan" style="width: 30%;float: left;">
				...
				<div class="col-xs-8 col-sm-4 btn-sespan" style="width: 25%;float: left;">
					<div class="input-group">
									<span class="input-group-addon">
				...
				<div class="input-group-btn">
					<a href="<?php echo url('service_list'); ?>">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="alldel" name="alldel" method="post" action="<?php echo url('service_alldel'); ?>" >
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<tbody id="ajax-data">
									<?php if(is_array($news) || $news instanceof \think\Collection): if( count($news)==0 ) : echo "" ;else: foreach($news as $key=>$v): ?>
	<tr>
		...
		<td><a href="<?php echo url('news_edit',array('n_id'=>$v['n_id'])); ?>" title="<?php echo $v['news_title']; ?>"><?php echo subtext($v['news_title'],25); ?></a>【<?php echo (isset($v['member_list_nickname']) && ($v['member_list_nickname'] !== '')?$v['member_list_nickname']:$v['member_list_username']); ?>】</td>
		<td class="hidden-sm hidden-xs"><?php echo $v['menu_name']; ?></td>
		
		<td class="hidden-xs">
			<?php if($v['news_open'] == 1): ?>
				<a class="red state-btn" href="<?php echo url('news_state'); ?>" data-id="<?php echo $v['n_id']; ?>" title="已审">
					<div><button class="btn btn-minier btn-yellow">已审</button></div>
				</a>
				<?php else: ?>
				<a class="red state-btn" href="<?php echo url('news_state'); ?>" data-id="<?php echo $v['n_id']; ?>" title="未审">
		...
		<td>
			<div class="hidden-sm hidden-xs action-buttons">
				<a class="green" href="<?php echo url('news_edit',array('n_id'=>$v['n_id'])); ?>" title="修改">
					<i class="ace-icon fa fa-pencil bigger-130"></i>
				</a>
				<a class="red confirm-rst-url-btn" data-info="你确定要删除到回收站吗？" href="<?php echo url('news_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="回收站" data-rel="tooltip" data-original-title="回收站">
			...
			<div class="hidden-md hidden-lg">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<li>
							<a href="<?php echo url('news_edit',array('n_id'=>$v['n_id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
											<span class="green">
						...
						<li>
							<a href="<?php echo url('news_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" data-info="你确定要删除到回收站吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="回收站" data-original-title="回收站">
											<span class="red">
...
<tr>
	...
	<td align="left" class="hidden-xs center"><button  id="btnorder" href="<?php echo url('news_order'); ?>" class="btn btn-white btn-yellow btn-sm">排序</button></td>
