<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:54:"D:\phpsite\YFCMF/app/admin\view\Service\news_back.html";i:1486180523;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:56:"D:\phpsite\YFCMF/app/admin\view\news\ajax_news_back.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<form name="admin_list_sea" class="form-search form-horizontal" id="list-filter" method="post" action="<?php echo url('news_back'); ?>">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="alldel" name="alldel" method="post" action="<?php echo url('news_back_alldel'); ?>" >
	...
	<tr>
		...
		<td>
			<div class="action-buttons">
				<a class="red confirm-rst-url-btn" data-info="你确定要还原文章到文章列表吗？" href="<?php echo url('news_back_open',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="还原">
					<i class="ace-icon fa fa-check bigger-130"></i>																</a>
				<a class="red confirm-rst-url-btn" data-info="你确定要彻底删除文章吗？" href="<?php echo url('news_back_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" title="删除">
			...
			<div class="hidden-md hidden-lg hidden-sm hidden-xs">
				<div class="inline position-relative">
					...
					<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
						<li>
							<a href="<?php echo url('news_back_open',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>" class="tooltip-success confirm-rst-url-btn" data-info="你确定要还原文章到文章列表吗？" data-rel="tooltip" title="" data-original-title="还原">
											<span class="green">
						...
						<li>
							<a href="<?php echo url('news_back_del',array('n_id'=>$v['n_id'],'p'=>input('p',1))); ?>"  class="tooltip-error confirm-rst-url-btn" data-info="你确定要彻底删除文章吗？" data-rel="tooltip" title="" data-original-title="删除">
											<span class="red">
