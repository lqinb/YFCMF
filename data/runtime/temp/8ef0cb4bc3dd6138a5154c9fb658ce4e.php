<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"D:\phpsite\YFCMF/app/admin\view\sys\sys.html";i:1484728251;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row">
			...
			<div class="tabbable">
				...
				<form class="form-horizontal ajaxForm2" name="sys" method="post" action="<?php echo url('runsys'); ?>">
					<fieldset>
						<div class="tab-content">
							<div id="basic" class="tab-pane fade in active">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="options[site_host]" id="site_host" value="<?php echo $sys['site_host']; ?>"  class="col-xs-10 col-sm-7" required/>
								<span class="help-inline col-xs-12 col-sm-5">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 站点主题 </label>
									<div class="col-sm-9">
										<select name="options[site_tpl]" id="site_tpl" class="col-xs-10 col-sm-7" required>
											<?php if(is_array($templates) || $templates instanceof \think\Collection): if( count($templates)==0 ) : echo "" ;else: foreach($templates as $key=>$vo): ?>
						...
						<span class="help-inline col-xs-12 col-sm-5">
							<span class="middle" id="restwo">*</span>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="private_key" id="private_key" value="<?php echo config('geetest.private_key'); ?>" class="col-xs-10 col-sm-7" />
										<span class="help-inline col-xs-12 col-sm-5">
									<span class="lbl"></span>
								</span>
									</div>
							...
							<div id="contact" class="tab-pane fade">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="options[site_qq]" id="site_qq" value="<?php echo $sys['site_qq']; ?>"  class="col-xs-10 col-sm-7" />
								<span class="help-inline col-xs-12 col-sm-5">
									<span class="middle" id="restwo"></span>
								</span>
									</div>
