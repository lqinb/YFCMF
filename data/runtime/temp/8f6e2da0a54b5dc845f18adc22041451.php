<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:56:"D:\phpsite\YFCMF/app/admin\view\sys\admin_rule_list.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		<div class="row maintop">
			<div style="margin:10px 0;" id="rule-add">
				<form class="form-horizontal ajaxForm2" name="admin_rule_add" method="post" action="<?php echo url('admin_rule_runadd'); ?>">
			...
			<div class="row">
				<div class="col-xs-12">
					<div>
						<form class="ajaxForm" name="ruleorder" method="post" action="<?php echo url('admin_rule_order'); ?>" >
							<table class="table table-striped table-bordered table-hover" id="dynamic-table">
								...
								<?php if(is_array($admin_rule) || $admin_rule instanceof \think\Collection): if( count($admin_rule)==0 ) : echo "" ;else: foreach($admin_rule as $key=>$v): ?>
									<tr id="<?php echo $pid; ?>-<?php echo $v['id']; ?>">
										...
										<td><a data-id="<?php echo $v['id']; ?>" data-level="<?php echo $v['level']; ?>" href="<?php echo url('admin_rule_list'); ?>" style="cursor:pointer;" class="rule-list"><span class="fa fa-plus blue"></span></a></td>
										...
										<td>
											<?php if($v['status'] == 1): ?>
												<a class="red display-btn" href="<?php echo url('admin_rule_state'); ?>" data-id="<?php echo $v['id']; ?>" title="已显示">
													<div id="zt<?php echo $v['id']; ?>"><button class="btn btn-minier btn-yellow">显示</button></div>
												</a>
												<?php else: ?>
												<a class="red display-btn" href="<?php echo url('admin_rule_state'); ?>" data-id="<?php echo $v['id']; ?>" title="已隐藏">
										...
										<td>
											<div class="hidden-sm hidden-xs action-buttons">
												<a class="blue" href="<?php echo url('admin_rule_add',array('pid'=>$v['id'])); ?>"  title="添加子类">
													<i class="ace-icon fa fa-plus-circle bigger-130"></i>
												</a>
												<a class="green" href="<?php echo url('admin_rule_edit',array('id'=>$v['id'])); ?>" title="修改">
													<i class="ace-icon fa fa-pencil bigger-130"></i>
												</a>
												<a class="green" href="<?php echo url('admin_rule_copy',array('id'=>$v['id'])); ?>" title="复制">
													<i class="ace-icon fa fa-exchange bigger-130"></i>
												</a>
												<a class="red confirm-rst-url-btn" href="<?php echo url('admin_rule_del',array('id'=>$v['id'])); ?>" data-info="你确定要删除吗？" title="删除">
											...
											<div class="hidden-md hidden-lg">
												<div class="inline position-relative">
													...
													<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
														<li>	
															<a href="<?php echo url('admin_rule_add',array('pid'=>$v['id'])); ?>"  class="tooltip-success" data-rel="tooltip" title="" data-original-title="添加子类">
																		<span class="green">
														...
														<li>
															<a href="<?php echo url('admin_rule_edit',array('id'=>$v['id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																			<span class="green">
														...
														<li>
															<a href="<?php echo url('admin_rule_copy',array('id'=>$v['id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="复制">
																			<span class="green">
														...
														<li>
															<a href="<?php echo url('admin_rule_del',array('id'=>$v['id'])); ?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																			<span class="red">
