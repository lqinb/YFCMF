<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:55:"D:\phpsite\YFCMF/app/admin\view\sys\admin_rule_add.html";i:1484560944;s:48:"D:\phpsite\YFCMF/app/admin\view\public\base.html";i:1484560944;s:50:"D:\phpsite\YFCMF/app/admin\view\public\header.html";i:1485050766;s:52:"D:\phpsite\YFCMF/app/admin\view\public\left_nav.html";i:1484560944;s:52:"D:\phpsite\YFCMF/app/admin\view\public\head_nav.html";i:1485050807;s:50:"D:\phpsite\YFCMF/app/admin\view\public\footer.html";i:1485050719;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="admin_rule_copy" method="post" action="<?php echo url('admin_rule_runadd'); ?>">
						...
						<div class="col-sm-9">
							<select name="pid"  class="col-xs-10 col-sm-5" required>
								...
								<?php if(is_array($admin_rule) || $admin_rule instanceof \think\Collection): if( count($admin_rule)==0 ) : echo "" ;else: foreach($admin_rule as $key=>$v): ?>
									<option value="<?php echo $v['id']; ?>" <?php if($v['id'] == $pid): ?>selected<?php endif; ?>><?php echo $v['lefthtml']; ?><?php echo $v['title']; ?></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-9" style="padding-top:5px;">
							<input name="status" value="1" class="ace ace-switch ace-switch-5" type="checkbox" />
							<span class="lbl"></span>
						</div>
					</div>
					<div class="space-4"></div>
