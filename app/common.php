...
//    print_r(in_array($str1,$data2));
//    if(similar_text($str1,$str2) > 6){
//        return 1;
//    }
    if(strstr($str1,$str2)!='' || strstr($str2,$str1)!=''){
        return 1;
    }
    if(in_array($str1,$data) && in_array($str2,$data)){
        return 1;
    }
    return 0;
//    return $percent;
